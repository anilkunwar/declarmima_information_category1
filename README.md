...
v24- : Both Document Processing and Query-time Reasoning Depend on the Choice of LLMs models, but Document Processing Occurs After Query is Asked. Tested on Laser Power
