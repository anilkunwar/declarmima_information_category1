...
def render_sunburst_chart(labels, parents, values, cmap_name="viridis"):
    ...
    fig = go.Figure(go.Sunburst(labels=labels, parents=parents, values=values, branchvalues="total", marker=dict(color=colors, line=dict(width=0.5, color="white")), textinfo="label+percent entry", insidetextorientation="radial"))
