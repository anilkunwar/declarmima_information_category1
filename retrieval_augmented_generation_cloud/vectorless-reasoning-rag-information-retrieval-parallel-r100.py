...
class ScientificIntentRouter:
    ...
    def route(self, query: str) -> Dict[str, Any]:
        ...
        weights = {
            "metadata": 0.8 if intent == "value_extraction" else 0.15,
            "keyword": 0.5 if intent == "value_extraction" else 0.25,
            "semantic": 0.2 if intent == "value_extraction" else 0.7,
            "tree_search": 0.4 if intent == "value_extraction" else 0.95,
            "equation_boost": 0.6 if intent == "equation" else 0.0,
