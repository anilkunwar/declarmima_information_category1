...
# -*- coding: utf-8 -*-
"""
DECLARMIMA v13.0 - ENHANCED PHYSICAL QUANTITY & MATERIAL EXTRACTION
=======================================================================
...
class PhysicalQuantityClassifier:
    ...
    UNIT_HINTS = {
        ...
        "yield_strength": ["mpa", "gpa", "psi"],        # NEW
        "tensile_strength": ["mpa", "gpa", "psi"],      # NEW
        "hardness": ["hv", "mpa", "gpa"],               # keep but with lower priority
    }
    ...
    def classify(self, parameter_name: Optional[str], unit: Optional[str], context: str) -> str:
        ...
        # 3. Unit hints (with prioritisation: strength over hardness when MPa appears with "yield")
        if unit:
            unit_lower = unit.lower()
            # First, check if context explicitly mentions strength
        ...
        if unit:
            ...
            if "mpa" in unit_lower or "gpa" in unit_lower:
                # if no strength keyword, fallback to hardness (but this is a known limitation)
                return "hardness"
