    ...
    if st.session_state.annotated_trees:
        ...
        if st.session_state.knowledge_graph and st.session_state.annotated_trees:
            ...
            if not df_all.empty:
                ...
                tabs = st.tabs(["📊 Histogram & Consensus", "🕸️ Knowledge Graph", "☀️ Sunburst & Treemap", "📡 Radar & Timeline", "⚡ Contradiction Matrix", "🔬 Embedding Spaces", "🔢 Quantitative Explorer", "🧠 Entity Explorer (KG Interaction)"])
                with tabs[0]:
                    if selected_qty != "All":
