...
# -*- coding: utf-8 -*-
"""
DECLARMIMA v18.0 - VECTORLESS DYNAMIC EQUATION-AWARE MULTI-PHYSICS RAG
================================================================================
Major upgrade from v17.1+ integrating 4 surgical code upgrades:
...
class QueryAnalyzer:
    ...
    def __init__(self, phys_classifier: PhysicalQuantityClassifier, concept_normalizer: ConceptNormalizer):
    ...
    def verify_items(self, items: List[UniversalExtractionItem], max_check_chars: int = 3000) -> List[UniversalExtractionItem]:
        ...
        for item in items:
            try:
                ...
                if val_str and val_str in page_text:
                ...
                elif item.item_type == "equation" and item.equation_latex:
                    # For equations, check if key terms appear
                    ...
                    if any(term in page_text for term in eq_terms[:3]):
                        ...
                        item.reasoning_trace += " [WARNING] Equation terms not found in cited page text."
                else:
...
- Return ONLY the structured text."""
    ...
    def generate(self, query: str, verified_items: List[UniversalExtractionItem]) -> str:
        items_json = json.dumps([i.to_dict() for i in verified_items[:15]], ensure_ascii=False, default=str)
        ...
        if run_query:
            with st.chat_message("assistant"):
                ...
                if extracted_values or equation_items:
                    ...
                    answer = page_gen.generate(active_prompt, items)
                else:
