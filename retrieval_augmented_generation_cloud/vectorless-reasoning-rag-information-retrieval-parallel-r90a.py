...
# -*- coding: utf-8 -*-
"""
DECLARMIMA v18.1 - VECTORLESS DYNAMIC EQUATION-AWARE MULTI-PHYSICS RAG
================================================================================
v18.0 Major upgrade (4 core architectural upgrades) + v18.1 Targeted fixes (5 gaps closed)
...
class TwoStageRetriever:
    ...
    def retrieve_relevant_docs(self, query: str, query_analysis: Optional[Dict[str, Any]] = None, top_k: int = 10) -> List[Tuple[str, float]]:
        ...
        for name, meta in self.doc_metadata.items():
            ...
            # Token overlap between query and document metadata (alloys + process types)
            meta_text = " ".join(meta.alloys + meta.process_types).lower()
            meta_tokens = set(re.findall(r'\w+', meta_text))
            ...
            summary_tokens = set(re.findall(r'\w+', summary_text))
