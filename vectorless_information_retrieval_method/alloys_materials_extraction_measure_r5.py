...
+ v2.4: Multi-Mode Label Alignment (Radial/Tangential/Horizontal/Vertical)
+ v2.4: Interactive Legend Filtering (Toggle Models/Consensus/DOI in Chord)
+ v2.5: Expanded Prettification Engine for Complex HEAs/IMCs from PDF Ground Truth
"""
...
# ------------------------------------------------------------------
st.set_page_config(
    page_title="AlloyExtraction Nexus — Memory-Hardened v2.5",
    page_icon="🔬",
    layout="wide",
...
# ------------------------------------------------------------------
# UNIFIED CHORD v2.5 — Multi-Mode Labels + Interactive Legend
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# CIRCOS v2.5 — Multi-Mode Label Alignment
# ------------------------------------------------------------------
...
# SIDEBAR
# ------------------------------------------------------------------
LABEL_MODE_OPTIONS = ['radial', 'tangential', 'horizontal', 'vertical']
...
with st.sidebar:
    ...
    with st.expander("Controls", expanded=False):
        ...
        chord_label_mode = st.selectbox("🔄 Label Orientation", LABEL_MODE_OPTIONS, index=0, key="chord_lm",
            help="Radial=outward from center. Tangential=parallel to arc. Horizontal=always upright. Vertical=90° rotated.")
    ...
    with st.expander("Controls", expanded=False):
        ...
        circos_label_mode = st.selectbox("🔄 Label Orientation", LABEL_MODE_OPTIONS, index=0, key="circos_lm",
            help="Radial=outward. Tangential=parallel to rim. Horizontal=always upright. Vertical=90° rotated.")
...
st.markdown('<div class="sub-header">Expanded Prettification • Multi-Mode Labels • Interactive Legend • 50+ Colormaps</div>', unsafe_allow_html=True)
...
if show_chord:
    with tabs[t_idx]:
        ...
        st.markdown("<div class='caption'>v2.5: Expanded prettification for HEAs/IMCs. Use <b>Label Orientation</b> to fix alignment. Use <b>Legend Visibility</b> to toggle models/consensus/DOI.</div>", unsafe_allow_html=True)
...
if show_circos:
    with tabs[t_idx]:
        ...
        st.markdown("<div class='caption'>v2.5: Expanded prettification. Use <b>Label Orientation</b> to switch between radial, tangential, horizontal, and vertical modes.</div>", unsafe_allow_html=True)
...
<div style="text-align:center; color:#666; font-size:0.88rem; padding:1rem 0; font-family:serif;">
    ...
    ✅ Expanded prettification for HEAs (Cr₀.₅W₀.₃(V-Nb-Ta)₀.₂), IMCs (Ti₂Cu/Ti-6Al-4V), and nitrides (B₀.₃Er₀.₅Al₀.₂N) | 
    ✅ Multi-mode label alignment (Radial / Tangential / Horizontal / Vertical) | 
    ✅ Interactive legend filtering (toggle Models / Consensus / DOI) | 
    ✅ Dynamic consensus recalculation based on visible models<br><br>
